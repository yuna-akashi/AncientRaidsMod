package ancientraids.expand.bullets;
...
public class AccelSpeedBulletType extends BasicBulletType {
    ...
    public AccelSpeedBulletType(){
        super();
    }

    public AccelSpeedBulletType(float velocityBegin, float velocityIncrease, Interp accelInterp, float damage, String bulletSprite){
    ...
    public AccelSpeedBulletType(float speed, float damage, String bulletSprite) {
        super(speed, damage, bulletSprite);
    }

    public AccelSpeedBulletType(float speed, float damage) {
        this(speed, damage, "bullet");
    }

    public AccelSpeedBulletType(float damage, String bulletSprite){
        super(1, damage, bulletSprite);
    }
