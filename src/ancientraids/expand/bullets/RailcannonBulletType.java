...
public class RailcannonBulletType extends BasicBulletType {
    ...
    public RailcannonBulletType(){
        super();
    }

    public RailcannonBulletType(float speed, float damage, String bulletSprite) {
        super(speed, damage, bulletSprite);

        impact = true;
    }

    public RailcannonBulletType(float speed, float damage) {
